...
public class AuthenticateDelegate {
    ...
    public AuthenticateDelegate() throws LDAPException {
        ...
        cachePool = new ConnectionPool(min, max, host, port, principal, credential);
    ...
    private String getUserDN(String uid) throws LDAPException {
        ...
        try {
            LDAPSearchResults searchResults = conn.search(userBaseDN, LDAPConnection.SCOPE_SUB, getUserFilter(uid),
